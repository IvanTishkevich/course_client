...
public class Supplies implements Serializable {
    ...
    public Supplies(Date supplyDate, int purchasePrice, int quantitySupplied, Technique technique, Providers provider) {
    ...
    public String toString() {
        return technique.getBrand() + " " + technique.getModel() + " " + supplyDate + " " + purchasePrice + " " + quantitySupplied+" "+provider.getName();
    }
}
